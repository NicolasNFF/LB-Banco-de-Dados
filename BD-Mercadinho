...
SELECT
 ...
 PED.PED_DT_EMISSAO AS 'DATA EMISSÃO',
...
SELECT
 ...
 TRIM(LOWER(CLI.CLI_ST_EMAIL)) AS 'EMAIL',
 PED.PED_IN_NUMERO  AS 'PEDIDO',
 DATEPART(DD,PED.PED_DT_EMISSAO) AS 'DATA EMISSÃO',
  DATEPART(MM,PED.PED_DT_EMISSAO) AS 'DATA EMISSÃO',
   DATEPART(YYYY,PED.PED_DT_EMISSAO) AS 'DATA EMISSÃO',
 PED.PED_RE_VALOR AS 'VALOR'
...
SELECT
 ...
 STR(DATEPART(YYYY,PED.PED_DT_EMISSAO),4,0) AS 'DATA EMISSÃO',
